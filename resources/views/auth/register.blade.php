...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="form-wrapper">
                ...
                <div class="form-group">
                    <div class="mt-3 text-start">
                        ...
                        <input type="text" name="name" id="name"
                            class="w-100 form-control @error('name') is-invalid @enderror" autofocus
                            value="{{ old('name') }}" title="Must be longer than 4 characters" autocomplete="name">
                ...
                <div class="form-group">
                    <div class="mt-3 text-start">
                        ...
                        <input type="email" name="email" id="email"
                            class="w-100 form-control @error('email') is-invalid @enderror" value="{{ old('email') }}"
                            autocomplete="email">
                        <span class="check-icon"></span>
                        @error('email')
                            <span class="invalid-feedback text-start" role="alert">
                ...
                <div class="form-group mb-3 mt-5">
                    <div class="mt-3 text-start">
                        ...
                        <input type="password" autocomplete="new-password" name="password_confirmation"
                            id="password-confirm" class="w-100 form-control @error('password') is-invalid @enderror">
                        <span class="check-icon"></span>
            ...
            <small>Have an account? <a href="{{ route('login') }}">Click here</a></small>
